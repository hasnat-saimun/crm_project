            ...
            <div class="col-md-6">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6 mb-2 mt-2">
                        ...
                        <input type="text" class="form-control" id="create" placeholder="" name="create" />
                    </div>
                    <div class="col-md-6 mb-2 mt-2">
                        <label for="convert" class="form-label">Converted from lead at</label>
                        <input type="text" class="form-control" id="convert" placeholder="" name="convert" />
                    </div>
                    <div class="col-md-6 mb-2 mt-2">
                        <label for="lastIp" class="form-label">Last ip</label>
                        <input type="number" class="form-control" id="lastIp" placeholder="" name="lastIp" />
                    </div>
                    <div class="col-md-6 mb-2 mt-2">
                        <label for="leadProvider" class="form-label">Lead provider</label>
                        <input type="text" class="form-control" id="leadProvider" placeholder="" name="leadProvider" />
                    </div>
                    <div class="col-md-6 mb-2 mt-2">
                        <label for="contactDate" class="form-label">Contact Date</label>
                        <input type="date" class="form-control" id="contactDate" placeholder="" name="contactDate" />
                    </div>
                </div>
