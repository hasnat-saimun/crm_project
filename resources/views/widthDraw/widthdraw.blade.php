    ...
    <div class="col-md-3">
        <div class="row">
            <div class="col-md-7 px-2">
                <h4 class="fw-bolder">Widthdrawals</h4>
            </div>
            ...
            <div class="col-md-3 px-2">
                <a href="{{route('widthdrawAdd')}}"><i class="fa-duotone fa-solid fa-user-plus fa-sm bg-success rounded p-3" style="--fa-primary-color: #ffffff; --fa-secondary-color: #ffffff; --fa-secondary-opacity: 1;"></i></a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
